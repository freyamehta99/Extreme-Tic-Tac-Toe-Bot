...
class Bot:
    ...
    def pattern_checker(self, flag, board, pos_array):
        # print "flag:",flag,"board:", board,"pos_arr:", pos_array
        flagCount = 0
        for pos in pos_array:
            # print "lelele",board[pos[0]][pos[1]]
    ...
    def heuristic(self, flag, gameBoard):
        ...
        # print "entered heuristic"
        if (self.finalHash, flag) in self.finalheuristic:
            # print"already got the score of final"
        ...
        # print "before the loop of board 1"
        #check should try optimizing "Two times looping" for board1 and board2
        for i in xrange(3):
            for j in xrange(3):
                # print i,j,"Here1"
                if sb1[i][j] == flag:
                    self.small_board1_weight = self.small_board_Points
                    ...
                    if (self.small_board1Hash[i][j], flag) in self.small_board1hueristic:
                        ...
                        # print "Here2",self.small_board_heuristic(flag,block)
                        # print "block",block
        ...
        # print "before the loop of board 2 "

        for i in xrange(3):
            for j in xrange(3):
                if sb2[i][j] == flag:
                    self.small_board2_weight = self.small_board_Points
        ...
        # print "calculating the board score"
        #cal bigboard1 score
        ...
        # print "scores -----", big_board2_score, big_board1_score
        # for i in xrange(3):
            # for j in xrange(3):
                # print 
        return total
    ...
    def minimax(self, board, flag, depth, maxDepth, alpha, beta, old_move):
        ...
        # print "entered minimax w flag n depth ",flag, depth
        ...
        if isMax:
            ...
            for i in xrange(len(validCells)):
                ...
                # print "valid cell_ weight=-------",validCells[i],val
    ...
    def move(self, board, old_move, flag):
        ...
        try:
            while True:
                ...
                b = deepcopy(board)
                # print "check -- ", self.minimax(b, flag, 0, maxDepth, float("-inf"), float("inf"), old_move)[1]
...
#         for pos_arr in self.patterns:
#             small_board_Heur += self.pattern_checker(flag, small_board_Heur, pos_arr)
