...
class Bot:
    ...
    def small_board_heuristic(self, flag, small_board):
        ...
        # print " after ptn", small_board_Heur

        for i in xrange(3):
            for j in xrange(3):
                if small_board[i][j] == flag:
                    small_board_Heur += 0.1 * self.cell_weight[i][j]
        # print "after all", small_board_Heur
